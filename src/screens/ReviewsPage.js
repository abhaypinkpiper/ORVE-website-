...
export default function ReviewsPage() {
  ...
  return (
    <div style={{ minHeight: '100vh', paddingTop: '80px', background: '#F5EFE0' }}>
      {/* Header */}
      <div style={{ background: 'linear-gradient(160deg, #2C1A0E 0%, #4A3020 100%)', padding: '80px 40px', textAlign: 'center' }}>
      ...
      {/* Tabs */}
      <div style={{ display: 'flex', borderBottom: '1px solid rgba(201,168,76,0.2)', background: '#FFFDF7', maxWidth: '900px', margin: '0 auto' }}>
      ...
      <div style={{ maxWidth: '900px', margin: '0 auto', padding: '60px 40px' }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
                  ...
                  {[1, 2, 3, 4, 5].map(star => (
                    <button
                      ...
                      style={{
                        ...
                        cursor: 'pointer',
                        fontSize: '2rem',
                        color: star <= reviewForm.rating ? '#C9A84C' : '#E2D5BE',
              ...
              <div>
                ...
                <textarea
                  ...
                  placeholder="Tell us about your experience with this jewellery..."
                  style={{ resize: 'vertical' }}
                />
              </div>
              {submitted && <p style={{ color: '#C9A84C', fontSize: '0.85rem', letterSpacing: '2px' }}>✨ Thank you! Your review is under moderation.</p>}
              <button className="btn-gold" onClick={handleReviewSubmit} style={{ fontSize: '0.7rem', letterSpacing: '3px', alignSelf: 'flex-start' }}>
                Submit Review
              </button>
            </div>
          </div>
        ...
        {tab === 'complaint' && (
          <div style={{ background: '#FFFDF7', padding: '50px 40px', borderTop: '3px solid', borderImage: 'linear-gradient(135deg, #C9A84C, #A07830) 1' }}>
            ...
            <p style={{ fontSize: '0.85rem', color: '#6B5540', lineHeight: 1.8, marginBottom: '40px' }}>
              We're sorry to hear you had an issue. Please share the details and we'll get back to you within 24 hours via WhatsApp.
            </p>
            <div style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
              <div>
                <label style={{ fontSize: '0.6rem', letterSpacing: '3px', color: '#C9A84C', fontWeight: 600, textTransform: 'uppercase', display: 'block', marginBottom: '10px' }}>Your Name</label>
              ...
              <div style={{ display: 'flex', gap: '16px', flexWrap: 'wrap' }}>
                <button className="btn-gold" onClick={handleComplaintSubmit} style={{ fontSize: '0.7rem', letterSpacing: '3px' }}>
                  Submit Complaint
                </button>
                <a
                  href="https://wa.me/917977459392?text=Hi%20ORVÉ!%20I%20have%20a%20complaint%20about%20my%20order."
                  target="_blank"
                  rel="noreferrer"
